...
public abstract class DirectionCalculator {
    private static final int DEPTH_DIFFERENCE = 5; //if there is a jump in depth of this size, assume increasing/decreasing
    ...
    public BPManager.DEPTH_DIRECTION getDepthDirection() {
        if(previousDirection == null) {
            return BPManager.DEPTH_DIRECTION.DECREASING; //must be increasing on start
        }
        ...
        //for other cases we check slope
